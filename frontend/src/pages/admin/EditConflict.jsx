...
import { getConflictById, updateConflict } from '../../services/conflictService';
...
const EditConflict = () => {
  ...
  return (
    <div className="flex-1 w-full max-w-2xl mx-auto px-6 py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-ink-50">Edit Conflict</h1>
        <p className="text-muted mt-2 text-sm">Update partial details for this conflict.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4 flex justify-end gap-3">
            ...
            <Button type="submit" variant="primary" disabled={isLoading}>
              {isLoading ? 'Updating...' : 'Update Conflict'}
            </Button>
          </div>
        </form>
      </div>
